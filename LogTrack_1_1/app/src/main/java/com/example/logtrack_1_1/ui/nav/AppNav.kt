...
import com.example.logtrack_1_1.ui.screens.today.AddEventScreen
...
fun AppNav(
    ...
    NavHost(
        ...
        composable(Route.Today.path) {
            TodayScreen(
                onOpenAddEvent = { navController.navigate(Route.AddEvent.path) }
            )
        }

        composable(Route.AddEvent.path) {
            AddEventScreen(
